...
<div class="grid grid-cols-3 gap-3 p-2">
	...
	<div></div>
	<div class="flex col-span-2 justify-start text-white">{launch.setZone(kscZoneId).toLocaleString(DateTime.DATETIME_MED_WITH_SECONDS)} EDT</div>
	<div></div>
</div>

<div class="pt-2 flex col-span-2 justify-center text-white text-2xl">
