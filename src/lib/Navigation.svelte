...
<div class="grid grid-cols-3 gap-4 p-2">
    <div>
        {#if left !== ""}
            <a data-sveltekit-preload-data="hover" class="btn rounded-md variant-filled-success py-1 flex justify-left text-black" href={left}>
