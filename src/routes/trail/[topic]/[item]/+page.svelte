...
<div class="grid grid-cols-3 gap-4 p-2">
    <div>
        {#if data.prev !== ""}
            <a class="btn rounded-md variant-filled-success py-1 flex justify-left text-black" href={data.prev}>
    ...
    <div>
        {#if data.next !== ""}
            <a class="btn rounded-md variant-filled-success py-1 flex justify-right text-black" href={data.next}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" class="w-6 h-6">
