...
<div class="pt-2 px-2">The launch of Euclid is hypotectically scheduled for the 1st of July, 2023 from the Cape Canaveral Space Force Station in Florida, USA.</div>
...
<div class="pt-2 px-2">In order to preserve Euclid's immaculate telescope and payload, the spacecraft and instruments have been built and launched in extremely clean conditions. Nonetheless some residual contaminants remain on the spacecraft, sometimes embedded in the spacecraft material. The spacecraft will also take water vapour from the Earth's atmosphere with it into space. The freezing vacuum of space naturally causes the contaminants to emerge into the interior spaces ('out-gassing'). This combination of contaminants and water vapour will naturally condense onto the coldest surface, and spacecraft is kept warm for several days and left to cool under carefully managed conditions to ensure the optical surfaces remain at their highest possible performance. The NISP instrument is partially activated during the LEOP phase to control the temperature with its enclosure.</div>

<div class="pt-4"><span class="text-white text-1xl bg-red-600 px-2">SPACECRAFT COMMISSIONING PHASE</span></div>
<div class="pt-2 px-2">With Euclid on its way to L2, the other spacecraft systems and cameras can be switched on. One week after launch the high-power antenna that transmits the science images to ground is deployed. This antenna has a narrow beam and thus is steerable to point at the gropund station receiving the data. With the high-power antenna switched on and storage system available, the instruments can be switched on and start taking images.</div>
<div class="pt-2 px-2">After 13 days the spacecraft has cooled and the VIS instrument is working correctly. The telescope will be focused through a painstaking process of searching for the best focus, moving the mirror motor mechanism by tiny amounts in 2 axes and measuring the focus of stars in VIS images. The Fine Guidance System uses the telescope to track the positions of stars on the sky and with the telescope in focus it can be activated to achieve the necessary precise pointing performance. With all elemnts in place, the spacecraft, instruments and telescope work together to capture Euclid's pristine images of the extra-galactic sky.</div>

<div class="pt-4"><span class="text-white text-1xl bg-red-600 px-2">PERFORMANCE VERIFICATION PHASE</span></div>
<div class="pt-2 px-2">1 month after launch and the spacectraft is now in orbit around L2 and the mission enters the Performance Verification phase, where the ability of the instruments to meet the exacting mission requirements is checked in space. Most of these measurements will not possible to make on ground since they need the full spaccraft operating at the nominal temperate observing distant stars and galaxies, something that is impossible to achieve in laboratories on Earth. This phase alos includes an initial assessment of the survey design in-flight, and the collection of data for the Early Release Observations, a early showcase of the Euclid mission. This mission phase lasts two months, after which ESA will review the results of the Spacecraft Commissioning and Performance Verification phases and authorise the start of the science mission phase.</div>
...
<div class="pt-2 px-2">With the spacecraft, telescope, instrument and processing at full speed the routine survey begins. There are three main elements to the Euclid Survey; the Wide Survey covering 14,000 square degrees of the extragalactic sky; the Deep Survey consisting of three areas of the sky observed to much greater depth, with a total area of 50 square degrees. The last component is calibration observations that monitor the performance of VIS and NISP and help understand the measurements made with the observations. The data processing system uses this data to ensure the best use of the science images from the instruments.</div>
<div class="pt-2 px-2">There are two great circles on the sky which are not suitable for the Euclid survey. The first is the Galactic Plane, which obscures the distant galaxies we wish to observe. The second is the Ecliptic Plane, where the planets and minor bodies orbit around the Sun. the ecliptic plane contains a lot of dust which contanminates the meaurements of the galaxies. Both the Galactic and Ecliptic Planes are excluded from the survey, leaving approximately one-third of the sky available for the science of the mission.</div>
