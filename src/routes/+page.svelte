...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="imgbckspace-y-5 w-96">
		<h1 class="h1">Learn all about Euclid</h1>
		{#each data.appdata.trails as trail}
			{#each trail.doc as doc} 
				...
				<div class="card m-2">
					...
					<footer class="card-footer flex justify-center bg-black rounded-none rounded-b-lg pl-1 py-2"><a class="btn rounded-md variant-filled-success py-1" href={trail.url}>Start trail</a></footer>
				</div>	
				{/if}
			{/each}
		{/each}
